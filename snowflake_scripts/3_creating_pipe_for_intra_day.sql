...
CREATE OR REPLACE STAGE MY_INTRA_DAY_S3_STAGE
  URL = 's3://YOUR_BUCKET/YOUR_PATH/'
  FILE_FORMAT = (TYPE = 'PARQUET');

-- Step 3: Create the Pipe in the RAW schema

CREATE OR REPLACE PIPE CRYPTO_DB.TRANSFORMED.MYPIPE_INTRA_DAY
  AUTO_INGEST = FALSE
  AS
  COPY INTO CRYPTO_DB.TRANSFORMED.CRYPTO_INTRA_DAY_DATA (
      ID,
      SYMBOL,
      NAME,
      CURRENT_PRICE,
